...
class Transfers extends Resource
{
     ...
     *
     * @param bool        $ascending   Control the order (newest or oldest) in which the transfers are returned. `false` will arrange the results with newest first whereas `true` shows oldest first
     ...
     */
    public function list(?bool $ascending, ?int $limit, ?string $startsAfter): Response
    {
